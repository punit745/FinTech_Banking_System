...
echo.
echo 5. Loading Advanced Features...
echo   - Currency Schema...
mysql -u %DB_USER% -p%DB_PASS% %DB_NAME% < ..\schema\02_currencies.sql
echo   - Forex Procedures...
mysql -u %DB_USER% -p%DB_PASS% %DB_NAME% < ..\procedures\03_forex_transfer.sql
echo   - Automated Interest Event...
mysql -u %DB_USER% -p%DB_PASS% %DB_NAME% < ..\events\01_daily_interest.sql
echo   - Security Roles...
mysql -u %DB_USER% -p%DB_PASS% %DB_NAME% < ..\security\01_roles.sql
